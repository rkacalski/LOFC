...
public class awaken2UI : MonoBehaviour
{
    ...
    string name = awakenManagere.card1.cardName;
    string nameTrim;
    ...
    void Start()
    {
        ...
        {
            if (i != awakenSelect1.card1PosinList && sortedBinder[i].cardName.Contains(awakenManagere.card1.cardName))
            {
