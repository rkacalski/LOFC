...
public class selectcoPilotI3PopUpUI : MonoBehaviour
{
    ...
    public void popup10()
    {
        ...
        vehicleModHelper.selectedVehicle.coPilots.Insert(2, tempCard);
        popUpImage.GetComponent<Image>().sprite = tempCard.cardArt;
        selectedPopUpmenu.transform.LeanScale(Vector2.one, 0.6f).setEaseOutQuart();
    }
    ...
    public void updateStats()
    {
        if (selectedCard.Equals(1))
        {
            ...
            vehicleModHelper.updatedATKcoPilot3 += updatedATK;
            vehicleModHelper.updatedDEFcoPilot3 += updatedDEF;
            vehicleModHelper.updatedCostcoPilot3 += tempCard.cost;
        }
