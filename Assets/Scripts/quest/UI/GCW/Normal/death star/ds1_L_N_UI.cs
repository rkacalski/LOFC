...
public class ds1_L_N_UI : MonoBehaviour
{
    public ds_L_baseChecks_N checks;
    public Text Level1;
    public Text Level2;
    public Text Level3;
    public Text Level4;
    ...
    void Start()
    {
        ...
        if (questProgress.ds1_6_complete_L_N == true)
        {
