...
public class tat1_L_N_UI : MonoBehaviour
{
    public tat_L_baseChecks_N checks;
    public Text Level1;
    public Text Level2;
    public Text Level3;
    public Text Level4;
    ...
    void Start()
    {
        ...
        if (questProgress.tat1_6_complete_L_N == true)
        {
