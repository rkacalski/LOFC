...
public class tat5_L_N_UI : MonoBehaviour
{
    public tat5_L_baseChecks_N checks;
    public Text Level1;
    public Text Level2;
    public Text Level3;
    public Text Level4;
    ...
    void Start()
    {
        ...
        if (questProgress.tat5_6_complete_L_N == true)
        {
